...
public class MainTest {
    ...
    public void testToSeeIfCounterWorks(){
        ...
        m.fillSquaresWithValue(0,0,0,0,1);
    ...
    public void testToSeeIfCounterWorksBoundaryMax(){
        Main m = new Main();
        m.lights = new int[3][3];
        m.fillSquaresWithValue(0,0,2,2,1);

        assertEquals(9, m.amountOfLightsOn());
    }

    @Test
    public void testToSeeIfAllAreOn(){
        Main m = new Main();
        m.fillSquaresWithValue(0,0, 999,999, 1); //turn all on.
        m.fillSquaresWithValue(499,499,500,500,0); // turn 4 on.
    ...
    public void testAllLightsAreOn(){
        Main m = new Main();
        m.fillSquaresWithValue(0,0, 999,999, 1);
