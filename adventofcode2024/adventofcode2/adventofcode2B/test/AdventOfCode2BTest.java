...
class AdventOfCode2BTest {
    ...
    @Test
    void testArray_ExpectsToBeUnsafeWithTwoNumbers() {
        int[] list = new int[]{1, 9};
        Assertions.assertFalse(app.calcisSafe(list, app));
    }

    @Test
    void testArray_ExpectsToBeUnsafeWithThreeNumbers() {
        int[] list = new int[]{1, 9, 5};
        Assertions.assertFalse(app.calcisSafe(list, app));
    }

    @Test
    void testArray_ExpectsToReturnUnsafeEnding() {
        int[] list = new int[]{16, 17, 18, 21, 23, 24, 120, 24};
        Assertions.assertFalse(app.calcisSafe(list, app));
    }

    @Test
    void testArray_ExpectsToReturnsafeWith1RandomNumberTrue() {
        int[] list = new int[]{16, 17, 18, 120, 21, 24, 25, 27};
        Assertions.assertTrue(app.checkWithDampener(list, app));
    }

    @Test
    void testArray_ExpectsToReturnSafeAsTrue() {
        int[] list = new int[]{24, 24};
        Assertions.assertFalse(app.calcisSafe(list, app));
    }

    @Test
    void testArray_ExpectsToBeUnsafeHasTwoUnsafeMoments() {
        int[] list = new int[]{1, 2, 7, 8, 9};
        Assertions.assertFalse(app.calcisSafe(list, app));
    }

    @Test
    void testArray_ExpectsToBeUnsafeHasTwoUnsafeAtTheEnd() {
    ...
    @Test
    void testArray_ExpectsToBeUnsafeHasTwoUnsafeIrregular() {
        int[] list = new int[]{1, 2, 7, 5, 6, 10, 8};
        Assertions.assertFalse(app.calcisSafe(list, app));
    }

    @Test
    void testArray_ExpectsToBeUnsafeHasOneUnsafeIrregularUpwards() {
    ...
    @Test
    void testArray_ExpectsToBeUnsafeHasOneUnsafeIrregularDownwards() {
    ...
    @Test
    void testArray_ExpectsToBeUnsafeHasMultipleUnsafeIrregular() {
    ...
    @Test
    void testArray_ExpectsToBeUnSafe_MultipleUpsAndDowns() {
    ...
    @Test
    void testArray_ExpectsToBeUnsafeHasMultipleUnsafeIrregularRegardingWhichLevel() {
        int[] list = new int[]{1, 2, 7, 8, 9}; // 2,7
        int[] list2 = new int[]{9, 7, 6, 2, 1}; // 6,2
    ...
    @Test
    void testArray_ExpectsTestInput() {
    ...
    @Test
    void testArray_ExpectsTestInputBeFalseSinceTwoErrors() {
    ...
    @Test
    void testArray_ExpectsTestInputBeFalseSinceTwoTimesFoundErrors() {
        int[] list = new int[]{65, 68, 66, 67, 69, 70, 73, 72}; //68 and 72 is wrong.
        Assertions.assertFalse(app.checkWithDampener(list, app));
    }

    @Test
    void testArray_ExpectsTestInputBeFalseSinceMultipleTimesFoundErrors() {
