...
public class testCard {
    ...
    public void checkSingleNumber() throws IOException {
        ...
        // int[] numberArray = a.getBingoNumber();
        // for (int i = 0; i < numberArray.length; i++) {
        //     checkMarkNumber(numberArray[i], a);
        //}
        a.markNumber(7);
    ...
    @Test
    public void calculateBingo() throws IOException {
        AdventOfCode4A a = new AdventOfCode4A();
        a.loadVariablesFromInput("D:\\development\\adventofcode\\src\\adventofcode2021\\adventofcode4a\\exampleTest.txt");
        a.calculateWinner();
        assertEquals("4512", a.calculusWinningNumberFromBoard());
    }
